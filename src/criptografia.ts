//(ab) (1, chave) resto
const alfa:string[] = ['a', 'b', 'c', 'd', 'e','f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z']

const resultadoDescriptografia:any = document.getElementById('resultado')
const botaoDecodificar:any = document.getElementById('decifrar')
const mensagemUsurario:any = document.getElementById('mensagem')

try {

//M1 == 
function descriptografarMensagem(mensagem:string) {
...
function voltarPalavra(palavra:string) {
    let traduzida = ''
    const /*[chave, palavraReal]*/infos:any = qualChave(palavra)
    let separada = infos.palavraReal.split('')

    separada.forEach((letraModificada: string) => {
...
function soPalavra(tudo:string, letraExtra:string){
